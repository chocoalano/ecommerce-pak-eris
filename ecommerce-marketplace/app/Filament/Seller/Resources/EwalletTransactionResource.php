...
use App\Filament\Seller\Resources\EwalletTransactionResource\Pages;
use App\Filament\Seller\Resources\EwalletTransactionResource\RelationManagers;
    ...
    public static function table(Table $table): Table
    {
        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\DeleteAction::make()->using(function($record) use ($proses){
