...
use App\Filament\Component\Forms\UserForm;
use App\Filament\Component\Tables\UserTable;
use App\Models\User;
...
class UserResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        ...
        return $table
            ...
            ->columns(UserTable::table())
            ->filters([
                Tables\Filters\TrashedFilter::make(),
                SelectFilter::make('type')->options(User::TYPE),
                Filter::make('activation')
                    ->toggle(),
